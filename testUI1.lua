...
function DiscordLib:Window(data)
    ...
    function ServerHold:Server(text, img)
        ...
        function ChannelHold:Channel(text)
            ...
            -- ============================================
            -- IMPROVED DROPDOWN WITH SEARCH BOX (CHLOE STYLE) - FIXED SCROLL
            -- ============================================
            ...
            function ChannelContent:Dropdown(flag, config)
                ...
                -- Dropdown Menu Container (untuk search box + list)
                local DropdownMenu = Instance.new("Frame")
                local DropdownMenuCorner = Instance.new("UICorner")
                local DropdownMenuBorder = Instance.new("UIStroke")
                ...
                DropdownButtonText.ZIndex = 1001
                ...
                DropdownArrow.ZIndex = 1001
                
                -- Dropdown Menu (Hidden by default)
                DropdownMenu.Name = "DropdownMenu"
                DropdownMenu.Parent = Dropdown
                DropdownMenu.BackgroundColor3 = Color3.fromRGB(32, 34, 37)
                DropdownMenu.Position = UDim2.new(0, 10, 0, 60)
                DropdownMenu.Size = UDim2.new(1, -20, 0, 0)
                DropdownMenu.ClipsDescendants = true
                DropdownMenu.Visible = false
                DropdownMenu.ZIndex = 2000
                
                DropdownMenuCorner.CornerRadius = UDim.new(0, 4)
                DropdownMenuCorner.Parent = DropdownMenu
                
                DropdownMenuBorder.Name = "Border"
                DropdownMenuBorder.Parent = DropdownMenu
                DropdownMenuBorder.Color = Color3.fromRGB(45, 47, 52)
                DropdownMenuBorder.Thickness = 1
                DropdownMenuBorder.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
                
                -- Search Container
                SearchContainer.Name = "SearchContainer"
                SearchContainer.Parent = DropdownMenu
                ...
                SearchIcon.TextSize = 12.000
                SearchIcon.ZIndex = 2002
                ...
                SearchBox.ZIndex = 2002
                
                -- Options Scroll (FIX: Ukuran lebih kecil agar muat)
                OptionsScroll.Name = "OptionsScroll"
                OptionsScroll.Parent = DropdownMenu
                OptionsScroll.BackgroundTransparency = 1.000
                OptionsScroll.BorderSizePixel = 0
                OptionsScroll.Position = UDim2.new(0, 5, 0, 38)
                OptionsScroll.Size = UDim2.new(1, -10, 1, -43)
                ...
                local function CreateOption(value)
                    ...
                    OptionButton.BackgroundColor3 = Color3.fromRGB(32, 34, 37)
                    OptionButton.BackgroundTransparency = 1.000
                    OptionButton.Size = UDim2.new(1, -5, 0, 26)
                ...
                local function RefreshOptions(searchQuery)
                    ...
                    if #filteredOptions == 0 then
                        ...
                        NoResults.TextSize = 11.000
                        NoResults.ZIndex = 2002
                    end
                end
                ...
                function DropdownFunc:Open()
                    ...
                    -- FIX: Ukuran menu disesuaikan (max 180px, lebih kecil dari sebelumnya)
                    local itemCount = math.min(#allOptions, 6) -- Max 6 items visible
                    local contentHeight = 38 + (itemCount * 27) + 5 -- Search (38) + items + padding
                    contentHeight = math.min(contentHeight, 180) -- Max height 180px
                    ...
                    game:GetService("TweenService"):Create(
                        Dropdown,
                        TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                        {Size = UDim2.new(0, 401, 0, 60 + contentHeight + 5)}
                    ):Play()
                ...
                game:GetService("UserInputService").InputBegan:Connect(function(input)
                    if input.UserInputType == Enum.UserInputType.MouseButton1 and isOpen then
                        task.wait(0.05)
                        if not isMouseOver(Dropdown) then
                            DropdownFunc:Close()
                        end
                    end
                end)
