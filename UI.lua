...
-- ============================================
local DiscordLib = {}
DiscordLib.Flags = {} -- Menyimpan semua element references
...
function DiscordLib:Window(data)
    ...
    local function InitAutoLoad()
        ...
        task.wait(0.5) -- Tunggu UI selesai dibuat
        
        local success = DiscordLib.ConfigSystem:LoadConfig(AutoLoadSystem.ConfigName)
        ...
        if AutoLoadSystem.AutoSave then
            spawn(function()
                while task.wait(AutoLoadSystem.AutoSaveInterval) do
                    DiscordLib.ConfigSystem:SaveConfig(AutoLoadSystem.ConfigName)
                    print("[DiscordLib] Auto-saved config at", os.date("%X"))
                end
            end)
        ...
        function ChannelHold:Channel(text)
            ...
            function ChannelContent:Slider(flag, config)
                ...
                if flag then
                    ...
                    DiscordLib.ConfigSystem:SetFlag(flag, start or 0)
                end
