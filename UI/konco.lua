...
do 
    ...
    local function GetItemsToFavorite()
        ...
        for _, item in ipairs(inventoryData.Items) do
            ...
            if not isMatch and isCustomName and table.find(customMutation, mutationFilterString) and table.find(customRarity, rarity) then
                isMatch = true
                print (masuk)
            end
    ...
    local toggleunfav = fishFav:Button({
        ...
        Callback = function()
            autoUnfavoriteState = true
            RunAutoUnfavoriteLoop()
            auautoUnfavoriteState = false
        end
    })
...
do
    ...
    local function onFishObtained(itemId, metadata, fullData)
        local success, results = pcall(function()
            ...
            print (fishRarityUpper)
            print (table.find(SelectedRarityCategories, fishRarityUpper))
