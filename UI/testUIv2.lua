...
function DiscordLib:Window(data)
    ...
    function ChannelContent:Dropdown(flag, config)
                ...
                -- Main Dropdown Button (TIDAK EXPAND)
                ...
                -- Side Panel Components (NO HEADER!)
                local SidePanelShadow = Instance.new("TextButton") -- Changed to TextButton for clicking
                ...
                CurrentSelectedText.Parent = DropdownButton
                CurrentSelectedText.BackgroundTransparency = 1.000
                CurrentSelectedText.Position = UDim2.new(0, 8, 0, 0)
                CurrentSelectedText.Size = UDim2.new(1, -35, 1, 0)
                CurrentSelectedText.Font = Enum.Font.Gotham
                CurrentSelectedText.Text = "..."
                CurrentSelectedText.TextColor3 = Color3.fromRGB(185, 187, 190)
                CurrentSelectedText.TextSize = 13.000
                CurrentSelectedText.TextXAlignment = Enum.TextXAlignment.Left
                CurrentSelectedText.TextTruncate = Enum.TextTruncate.AtEnd
                CurrentSelectedText.ZIndex = 101
                ...
                -- ============================================
                -- SIDE PANEL SETUP (NO HEADER!)
                -- ============================================
                
                -- Shadow Overlay (CLICKABLE untuk close!)
                SidePanelShadow.Name = "SidePanelShadow"
                SidePanelShadow.Parent = ChannelHolder.Parent
                ...
                SidePanelShadow.AutoButtonColor = false
                SidePanelShadow.Text = ""
                
                -- Side Panel (NO HEADER - lebih banyak space!)
                SidePanel.Name = "SidePanel_" .. (config.Title or "Dropdown")
                SidePanel.Parent = ChannelHolder.Parent
                ...
                -- Search Container (NOW AT TOP - no header above it!)
                SearchContainer.Name = "SearchContainer"
                SearchContainer.Parent = SidePanel
                SearchContainer.BackgroundColor3 = Color3.fromRGB(40, 42, 46)
                SearchContainer.BorderSizePixel = 0
                SearchContainer.Position = UDim2.new(0, 10, 0, 10) -- Start from top with small padding
                ...
                SearchBorder.Parent = SearchContainer
                SearchBorder.Color = Color3.fromRGB(45, 47, 52)
                ...
                -- Options Scroll (MORE SPACE - no header!)
                OptionsScroll.Name = "OptionsScroll"
                OptionsScroll.Parent = SidePanel
                OptionsScroll.BackgroundTransparency = 1.000
                OptionsScroll.BorderSizePixel = 0
                OptionsScroll.Position = UDim2.new(0, 10, 0, 55) -- Right after search
                OptionsScroll.Size = UDim2.new(1, -20, 1, -65) -- Much more space! (was -110, now -65)
                ...
                local function CreateItem(v)
                    ...
                    local ItemDivider = Instance.new("Frame") -- Separator line
                    
                    Item.Name = "Item"
                    Item.Parent = OptionsScroll
                    Item.BackgroundColor3 = Color3.fromRGB(40, 42, 46)
                    ...
                    -- Grid separator line at bottom
                    ItemDivider.Name = "ItemDivider"
                    ItemDivider.Parent = Item
                    ItemDivider.BackgroundColor3 = Color3.fromRGB(45, 47, 52) -- Subtle line
                    ItemDivider.BorderSizePixel = 0
                    ItemDivider.Position = UDim2.new(0, 5, 1, -1) -- Bottom of item
                    ItemDivider.Size = UDim2.new(1, -10, 0, 1) -- Thin line with padding
                    ItemDivider.ZIndex = 1003
                    
                    ItemText.Name = "ItemText"
                    ItemText.Parent = Item
                    ItemText.BackgroundTransparency = 1.000
                    ItemText.Position = UDim2.new(0, 35, 0, 0)
                    ItemText.Size = UDim2.new(1, -40, 1, 0)
                    ItemText.Font = Enum.Font.Gotham
                    ItemText.Text = v
                    ItemText.TextColor3 = Color3.fromRGB(220, 221, 222)
                    ...
                    Item.MouseEnter:Connect(function()
                        ...
                        Item.BackgroundColor3 = Color3.fromRGB(47, 49, 54)
                    end)
                ...
                local function RefreshOptions(searchQuery)
                    ...
                    for _, v in pairs(config.List) do
                        if searchQuery == "" or v:lower():find(searchQuery, 1, true) then
                ...
                function DropFunc:SetValue(val)
                    ...
                    -- Update checkmarks if panel is visible
                ...
                function DropFunc:Clear()
                    ...
                    if flag then
                        DiscordLib.ConfigSystem:SetFlag(flag, config.Multi and {} or "")
                    end
                end
                
                function DropFunc:Add(textadd)
                    table.insert(config.List, textadd)
                ...
                function DropFunc:Refresh(newlist)
                    ...
                    -- Validate selected items still exist in new list
                    local newSelected = {}
                    for _, sel in pairs(selected) do
                ...
                -- Click shadow (dark area) to close
                SidePanelShadow.MouseButton1Click:Connect(function()
                    DropFunc:Close()
                end)
