...
function DiscordLib:Window(data)
    ...
    function ServerHold:Server(text, img)
        ...
        function ChannelHold:Channel(text)
            ...
            -- ============================================
            -- IMPROVED DROPDOWN WITH SEARCH BOX (CHLOE STYLE)
            -- ============================================
            
            -- Tambahkan function Dropdown yang diperbaiki ini ke dalam ChannelContent
            -- Ganti function Dropdown yang lama dengan yang ini
            ...
            function ChannelContent:Dropdown(flag, config)
                ...
                DropdownArrow.Image = "rbxassetid://6031090997" -- Down arrow
                ...
                DropdownMenu.Size = UDim2.new(1, -20, 0, 0) -- Start collapsed
                ...
                local function CreateOption(value)
                    ...
                    OptionCheckmark.Position = UDim2.new(0, 8, 0, 0)
                    OptionCheckmark.Size = UDim2.new(0, 20, 1, 0)
                    OptionCheckmark.Font = Enum.Font.GothamBold
                    OptionCheckmark.Text = ""
                    OptionCheckmark.TextColor3 = Color3.fromRGB(88, 101, 242) -- Discord blue
                    OptionCheckmark.TextSize = 14.000
                ...
                function DropdownFunc:Open()
                    ...
                    local contentHeight = math.min(200, 40 + (#allOptions * 30) + 10)
                ...
                function DropdownFunc:SetValue(value)
                    if config.Multi then
                        ...
                        if type(value) == "table" then
                            ...
                            DropdownButtonText.Text = table.concat(value, ", ")
                        end
                    else
                        selectedValues = {[value] = true}
                        DropdownButtonText.Text = value
