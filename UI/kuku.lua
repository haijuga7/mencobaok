...
do 
    ...
    local function testlll()
        RF_CancelFishingInputs:InvokeServer()
        task.spawn(function()
            pcall(function() RF_ChargeFishingRod:InvokeServer(nil, nil, nil, 1769972555.6933) end)
        end)
        task.spawn(function()
            pcall(function() RF_RequestFishingMinigameStarted:InvokeServer(1, 1, 1769972555.6933) end)
        end)
        task.spawn(function()
            task.wait(0.5)
            RF_CancelFishingInputs:InvokeServer()
    ...
    local function blatantFishv2()
        ...
        task.wait(blatV2de)
        pcall(function() RE_FishingCompleted:InvokeServer() end)
    end
