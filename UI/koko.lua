...
do
    ...
    UI.autoERod = fishSupport:Toggle("autoerod", {
...
do 
    ...
    local BlatantV1Cancel = fishMain:Textbox("blatV1cancel", { -- ✅ DIPERBAIKI
        Title = "Cancel Delay",
        Placeholder = "ex: 1",
        Callback = function(val)
            blatv1canc = tonumber(val)
        end
    })
