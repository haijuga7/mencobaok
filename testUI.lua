...
local function AddBottomControls(mainFrame, topFrame, data)
    -- ============================================
    -- BOTTOM DRAG BAR (untuk drag window)
    -- ============================================
    local BottomDragBar = Instance.new("Frame")
    BottomDragBar.Name = "BottomDragBar"
    BottomDragBar.Parent = mainFrame
    BottomDragBar.AnchorPoint = Vector2.new(0.5, 1)
    BottomDragBar.BackgroundColor3 = Color3.fromRGB(32, 34, 37)
    BottomDragBar.BorderSizePixel = 0
    BottomDragBar.Position = UDim2.new(0.5, 0, 1, 0)
    BottomDragBar.Size = UDim2.new(1, 0, 0, 35)
    BottomDragBar.ZIndex = 5

    -- Corner untuk bottom bar
    local BottomBarCorner = Instance.new("UICorner")
    BottomBarCorner.CornerRadius = UDim.new(0, 0)
    BottomBarCorner.Parent = BottomDragBar
    ...
    -- ⚡ ENABLE BOTTOM BAR DRAG
    MakeDraggable(BottomDragBar, mainFrame)

    -- ============================================
    -- VERSION LABEL (Opsional)
    -- ============================================
    ...
    if data.Resizable then
        ...
        ResizeHandle.Position = UDim2.new(1, -8, 1, -8) -- Posisi di pojok kanan bawah
