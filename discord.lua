...
function DiscordLib:Window(data)
    ...
    TopFrame.Size = UDim2.new(1, 0, 0, 22)  -- ✅ Width pakai Scale (1 = 100%)
    ...
    TopFrameHolder.Size = UDim2.new(1, 0, 0, 22)  -- ✅ Width pakai Scale
    
    Title.Name = "Title"
    Title.Parent = TopFrame
    Title.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    Title.BackgroundTransparency = 1.000
    Title.Position = UDim2.new(0.01, 0, 0, 0)  -- ✅ Pakai Scale
    ...
    Userpad.Position = UDim2.new(0.106, 0, 1, -43)  -- ✅ Anchor ke bottom
    Userpad.Size = UDim2.new(0, 179, 0, 43)
    Userpad.AnchorPoint = Vector2.new(0, 1)  -- ✅ Anchor bottom-left
    ...
    ServersHoldFrame.Position = UDim2.new(0, 0, 0, 0)
    ServersHoldFrame.Size = UDim2.new(0, 71, 1, 0)  -- ✅ Height = 100% MainFrame
    ...
    ServersHold.Position = UDim2.new(0, 0, 0.058, 0)  -- ✅ Pakai Scale
    ServersHold.Size = UDim2.new(1, 0, 0.942, 0)  -- ✅ 94.2% dari parent
    ...
    MaximizeBtn.MouseButton1Click:Connect(function()
        if isMaximized == false then
            ...
            local targetSize = UDim2.new(0, viewportSize.X * 0.95, 0, viewportSize.Y * 0.95)
            ...
            MaximizeIcon.Image = "rbxassetid://6035067836" -- Minimize icon as restore
            ...
            -- Change icon back
            MaximizeIcon.Image = "rbxassetid://6035047377"
        end
    ...
    SettingsFrame.Size = UDim2.new(1, 0, 1, 0)  -- ✅ 100% x 100%
    ...
    Settings.Size = UDim2.new(1, 0, 0.947, 0)  -- ✅ 94.7% height
    ...
    SettingsHolder.Size = UDim2.new(1, 0, 1, 0)  -- ✅ 100% x 100%
    ...
    UserPanel.Position = UDim2.new(0.366, 0, 0.131, 0)  -- ✅ Scale position
    ...
    LeftFrame.Size = UDim2.new(0, 233, 1, 0)  -- ✅ Full height
    ...
    function ServerHold:Server(text, img)
        ...
        ServerFrame.Position = UDim2.new(0.104, 0, 0, 22)  -- ✅ Start after topbar
        ServerFrame.Size = UDim2.new(0.895, 0, 1, -22)  -- ✅ 89.5% width, 100% height - 22px
        ...
        ServerFrame1.Position = UDim2.new(0, 0, 0.972, 0)  -- ✅ Scale
        ...
        ServerFrame2.Position = UDim2.new(0.98, 0, 0.972, 0)  -- ✅ Scale
        ...
        GlowFrame.Size = UDim2.new(1, 0, 0, 40)  -- ✅ Width = 100%
        ...
        ServerContentFrame.Position = UDim2.new(0, 0, 0, 40)
        ServerContentFrame.Size = UDim2.new(0, 180, 1, -40)  -- ✅ Height = 100% - 40px
        ...
        ChannelTitleFrame.Position = UDim2.new(0.295, 0, 0, 0)  -- ✅ Scale position
        ChannelTitleFrame.Size = UDim2.new(0.705, 0, 0, 40)  -- ✅ 70.5% width
        ...
        ChannelContentFrame.Position = UDim2.new(0.295, 0, 0, 40)  -- ✅ Start after title
        ChannelContentFrame.Size = UDim2.new(0.705, 0, 1, -40)  -- ✅ 70.5% width, 100% height - 40
        ...
        GlowChannel.Size = UDim2.new(1.064, 30, 0.228, 30)  -- ✅ Scale
        ...
        ServerChannelHolder.Size = UDim2.new(1, -2, 0.835, 0)  -- ✅ 83.5% height
        ...
        function ChannelHold:Channel(text)
            ...
            ChannelHolder.Size = UDim2.new(0.96, 0, 0.943, 0)  -- ✅ 96% width, 94.3% height
            ...
            function ChannelContent:Toggle(flag, config)
                ...
                Toggle.Size = UDim2.new(0.97, 0, 0, 30)  -- ✅ 97% width
    ...
    local SliderFunc = {}
                ...
                Slider.Size = UDim2.new(0.97, 0, 0, 38)
                Slider.AutoButtonColor = false
                Slider.Font = Enum.Font.Gotham
                Slider.Text = ""
                Slider.TextColor3 = Color3.fromRGB(255, 255, 255)
                Slider.TextSize = 14.000  -- ✅ DIPERBAIKI (ada typo "14." di document)
                ...
                SliderFrame.Name = "SliderFrame"  -- ✅ DIPERBAIKI (bukan SliderFrameSliderFrame)
                SliderFrame.Parent = Slider
                SliderFrame.AnchorPoint = Vector2.new(0.5, 0.5)
                SliderFrame.BackgroundColor3 = Color3.fromRGB(79, 84, 92)
                SliderFrame.Position = UDim2.new(0.5, 0, 0.757, 0)
                SliderFrame.Size = UDim2.new(0.96, 0, 0, 8)
            ...
            function ChannelContent:Seperator()
                ...
                Seperator1.Position = UDim2.new(0, 0, 0, 0)
                Seperator1.Size = UDim2.new(0.97, 0, 0, 8)  -- ✅ 97% width
                ...
                Seperator2.Size = UDim2.new(1, 0, 0, 1)  -- ✅ 100% dari parent
                ChannelHolder.CanvasSize = UDim2.new(0,0,0,ChannelHolderLayout.AbsoluteContentSize.Y)
            end
            ...
            function ChannelContent:Dropdown(flag, config)
                ...
                Dropdown.Size = UDim2.new(0.97, 0, 0, 73)  -- ✅ 97% width
                ...
                DropdownFrameOutline.Position = UDim2.new(0.5, 0, 1.62, 0)
                DropdownFrameOutline.Size = UDim2.new(0.98, 0, 0, 36)  -- ✅ 98% width
                ...
                DropdownFrame.Size = UDim2.new(0.97, 0, 0, 32)  -- ✅ 97% width
            ...
            function ChannelContent:Colorpicker(flag, config)
                ...
                Colorpicker.Size = UDim2.new(0.97, 0, 0, 175)
            ...
            function ChannelContent:Textbox(flag, config)
                ...
                Textbox.Size = UDim2.new(0.97, 0, 0, 73)  -- ✅ 97% width
                ...
                TextboxFrameOutline.Size = UDim2.new(0.98, 0, 0, 36)  -- ✅ 98% width
                ...
                TextboxFrame.Size = UDim2.new(0.97, 0, 0, 32)  -- ✅ 97% width
            ...
            function ChannelContent:Label(text)
                ...
                Label.Size = UDim2.new(0.97, 0, 0, 30)  -- ✅ 97% width
            ...
            function ChannelContent:Bind(flag, config)
                ...
                Keybind.Size = UDim2.new(0.97, 0, 0, 30)  -- ✅ 97% width
