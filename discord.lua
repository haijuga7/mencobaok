...
-- ============================================
-- BOTTOM DRAG BAR + CORNER RESIZE HANDLE
-- ============================================
local function AddBottomControls(mainFrame, topFrame, data)
    ...
    BottomDragBar.BackgroundColor3 = Color3.fromRGB(25, 27, 29)
    BottomDragBar.BorderSizePixel = 0
    BottomDragBar.Position = UDim2.new(0.5, 0, 1, 0)
    BottomDragBar.Size = UDim2.new(1, 0, 0, 30)
    ...
    -- Icon garis-garis untuk drag (seperti gambar)
    ...
    -- Buat 6 titik horizontal (drag indicator)
    for i = 1, 6 do
        ...
        Dot.Position = UDim2.new((i - 1) * 0.17, 0, 0, 0)
    ...
    if data.Resizable then
        ...
        ResizeHandle.Position = UDim2.new(1, -5, 1, -35) -- Di atas bottom bar
        ...
        ResizeIcon.Image = "rbxassetid://7072706037"
    ...
    BottomDragBar.MouseEnter:Connect(function()
        for _, dot in pairs(DragIcon:GetChildren()) do
