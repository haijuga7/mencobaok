...
function DiscordLib.ConfigSystem:ListConfigs()
    ...
    if isfolder(self.ConfigFolder) then
        for _, file in pairs(listfiles(self.ConfigFolder)) do
            table.insert(configs, file:gsub(self.ConfigFolder.."/", ""):gsub(".json", ""))
        end
    end
    return configs
end
...
function DiscordLib:Window(data)
    ...
    MaximizeBtn.Parent = TopFrame
    MaximizeBtn.BackgroundColor3 = Color3.fromRGB(32, 34, 37)
    MaximizeBtn.BackgroundTransparency = 0
    MaximizeBtn.Position = UDim2.new(0.876831055, 0, -0.0169996787, 0) -- Di tengah
    MaximizeBtn.Size = UDim2.new(0, 28, 0, 22)
    MaximizeBtn.Font = Enum.Font.Gotham
    MaximizeBtn.Text = ""
    MaximizeBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
    MaximizeBtn.TextSize = 14.000
    MaximizeBtn.BorderSizePixel = 0
    MaximizeBtn.AutoButtonColor = false
    
    MaximizeIcon.Name = "MaximizeIcon"
    MaximizeIcon.Parent = MaximizeBtn
    MaximizeIcon.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    MaximizeIcon.BackgroundTransparency = 1.000
    MaximizeIcon.Position = UDim2.new(0.189182192, 0, 0.128935531, 0)
    MaximizeIcon.Size = UDim2.new(0, 17, 0, 17)
    MaximizeIcon.Image = "rbxassetid://6035047377" -- Square icon untuk maximize
    MaximizeIcon.ImageColor3 = Color3.fromRGB(220, 221, 222)
    ...
    -- ============================================
    -- MAXIMIZE FUNCTIONALITY (PERBAIKAN)
    -- ============================================
    local isMaximized = false
    local originalSize = UDim2.new(0, 681, 0, 396)
    ...
    MaximizeBtn.MouseButton1Click:Connect(function()
        if isMaximized == false then
            ...
            local targetWidth = viewportSize.X * 0.95
            local targetHeight = viewportSize.Y * 0.95
            
            -- ✅ PERBAIKAN: Resize MainFrame
            MainFrame:TweenSizeAndPosition(
                UDim2.new(0, targetWidth, 0, targetHeight),
            ...
            -- ✅ Resize TopFrame (header)
            TopFrame:TweenSize(
                UDim2.new(0, targetWidth, 0, 22),
                Enum.EasingDirection.Out,
                Enum.EasingStyle.Quart,
                0.3,
                true
            ...
            -- ✅ Resize ServersHoldFrame (sidebar kiri)
            ServersHoldFrame:TweenSize(
                UDim2.new(0, 71, 0, targetHeight),
                Enum.EasingDirection.Out,
                Enum.EasingStyle.Quart,
                0.3,
                true
            ...
            ServersHold:TweenSize(
                UDim2.new(0, 71, 0, targetHeight - 23),
                Enum.EasingDirection.Out,
                Enum.EasingStyle.Quart,
                0.3,
                true
            ...
            -- ✅ Resize Userpad
            Userpad:TweenPosition(
                UDim2.new(0.106243297, 0, 0, (targetHeight - 43) - 23),
                Enum.EasingDirection.Out,
                Enum.EasingStyle.Quart,
                0.3,
                true
            ...
            -- ✅ Resize All Server Frames
            for _, serverFrame in pairs(ServersHolder:GetChildren()) do
                if serverFrame.Name == "ServerFrame" then
                    -- Server frame (main content area)
                    serverFrame:TweenSize(
                        UDim2.new(0, targetWidth - 71, 0, targetHeight - 23),
                        Enum.EasingDirection.Out,
                        Enum.EasingStyle.Quart,
                        0.3,
                        true
                    ...
                    -- ServerTitleFrame
                    local titleFrame = serverFrame:FindFirstChild("ServerTitleFrame")
                    if titleFrame then
                        titleFrame:TweenSize(
                    ...
                    if glowFrame then
                        glowFrame:TweenSize(
                            UDim2.new(0, targetWidth - 71, 0, 40),
                            Enum.EasingDirection.Out,
                            Enum.EasingStyle.Quart,
                            0.3,
                            true
                    ...
                    -- ServerContentFrame (left sidebar dalam server)
                    local contentFrame = serverFrame:FindFirstChild("ServerContentFrame")
                    if contentFrame then
                        contentFrame:TweenSize(
                            UDim2.new(0, 180, 0, targetHeight - 23 - 40),
                            Enum.EasingDirection.Out,
                            Enum.EasingStyle.Quart,
                            0.3,
                            true
                        ...
                        -- ServerChannelHolder
                        local channelHolder = contentFrame:FindFirstChild("ServerChannelHolder")
                        if channelHolder then
                            channelHolder:TweenSize(
                                UDim2.new(0, 179, 0, targetHeight - 23 - 40 - 55),
                                Enum.EasingDirection.Out,
                                Enum.EasingStyle.Quart,
                                0.3,
                                true
                    ...
                    -- ChannelTitleFrame (header channel)
                    local channelTitleFrame = serverFrame:FindFirstChild("ChannelTitleFrame")
                    if channelTitleFrame then
                        channelTitleFrame:TweenSize(
                            UDim2.new(0, targetWidth - 71 - 180, 0, 40),
                            Enum.EasingDirection.Out,
                            Enum.EasingStyle.Quart,
                            0.3,
                            true
                    ...
                    -- ChannelContentFrame (main content area)
                    local channelContentFrame = serverFrame:FindFirstChild("ChannelContentFrame")
                    if channelContentFrame then
                        channelContentFrame:TweenSize(
                            UDim2.new(0, targetWidth - 71 - 180, 0, targetHeight - 23 - 40),
                            Enum.EasingDirection.Out,
                            Enum.EasingStyle.Quart,
                            0.3,
                            true
                        ...
                        -- Resize all ChannelHolders
                        for _, channelHolder in pairs(channelContentFrame:GetChildren()) do
                            if channelHolder.Name == "ChannelHolder" then
                                channelHolder:TweenSize(
                                    UDim2.new(0, targetWidth - 71 - 180 - 31, 0, targetHeight - 23 - 40 - 19),
                                    Enum.EasingDirection.Out,
                                    Enum.EasingStyle.Quart,
                                    0.3,
                                    true
                                ...
                                -- ✅ Resize elements inside channel
                                for _, element in pairs(channelHolder:GetChildren()) do
                                    if element:IsA("GuiObject") and element.Name ~= "ChannelHolderLayout" then
                                        local currentSize = element.Size
                                        element:TweenSize(
                                            UDim2.new(0, targetWidth - 71 - 180 - 31 - 11, currentSize.Y.Offset, 0),
                                            Enum.EasingDirection.Out,
                                            Enum.EasingStyle.Quart,
                                            0.3,
                                            true
            ...
            if SettingsFrame then
                ...
                if settings then
                    settings:TweenSize(
                        UDim2.new(0, targetWidth, 0, targetHeight - 21),
                        Enum.EasingDirection.Out,
                        Enum.EasingStyle.Quart,
                        0.3,
                        true
                    ...
                    local settingsHolder = settings:FindFirstChild("SettingsHolder")
            ...
            -- Change icon
            MaximizeIcon.Image = "http://www.roblox.com/asset/?id=6034818372"
            ...
            -- Restore ServersHoldFrame
            ServersHoldFrame:TweenSize(
                UDim2.new(0, 71, 0, 396),
                Enum.EasingDirection.Out,
                Enum.EasingStyle.Quart,
                0.3,
                true
            ...
            -- Restore Userpad
            Userpad:TweenPosition(
                UDim2.new(0.106243297, 0, 15.9807148, 0),
                Enum.EasingDirection.Out,
                Enum.EasingStyle.Quart,
                0.3,
                true
            ...
            -- Restore all Server Frames
            for _, serverFrame in pairs(ServersHolder:GetChildren()) do
                if serverFrame.Name == "ServerFrame" then
                    serverFrame:TweenSize(
                        UDim2.new(0, 609, 0, 373),
                        Enum.EasingDirection.Out,
                        Enum.EasingStyle.Quart,
                        0.3,
                        true
                    ...
                    local titleFrame = serverFrame:FindFirstChild("ServerTitleFrame")
                    if titleFrame then
                        titleFrame:TweenSize(UDim2.new(0, 180, 0, 40), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.3, true)
                    end
                    
                    local glowFrame = serverFrame:FindFirstChild("GlowFrame")
                    if glowFrame then
                        glowFrame:TweenSize(UDim2.new(0, 609, 0, 40), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.3, true)
                    end
                    
                    local contentFrame = serverFrame:FindFirstChild("ServerContentFrame")
                    if contentFrame then
                        contentFrame:TweenSize(UDim2.new(0, 180, 0, 333), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.3, true)
                        
                        local channelHolder = contentFrame:FindFirstChild("ServerChannelHolder")
                        if channelHolder then
                            channelHolder:TweenSize(UDim2.new(0, 179, 0, 278), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.3, true)
                        end
                    end
                    
                    local channelTitleFrame = serverFrame:FindFirstChild("ChannelTitleFrame")
                    if channelTitleFrame then
                        channelTitleFrame:TweenSize(UDim2.new(0, 429, 0, 40), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.3, true)
                    end
                    
                    local channelContentFrame = serverFrame:FindFirstChild("ChannelContentFrame")
                    if channelContentFrame then
                        channelContentFrame:TweenSize(UDim2.new(0, 429, 0, 333), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.3, true)
                        
                        for _, channelHolder in pairs(channelContentFrame:GetChildren()) do
                            if channelHolder.Name == "ChannelHolder" then
                                channelHolder:TweenSize(UDim2.new(0, 412, 0, 314), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.3, true)
                                
                                -- Restore element sizes
                                for _, element in pairs(channelHolder:GetChildren()) do
                                    if element:IsA("GuiObject") and element.Name ~= "ChannelHolderLayout" then
                                        local currentSize = element.Size
                                        element:TweenSize(
                                            UDim2.new(0, 401, currentSize.Y.Offset, 0),
                                            Enum.EasingDirection.Out,
                                            Enum.EasingStyle.Quart,
                                            0.3,
                                            true
            ...
            -- Restore Settings
            if SettingsFrame then
                SettingsFrame:TweenSize(UDim2.new(0, 681, 0, 396), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.3, true)
                
                local settings = SettingsFrame:FindFirstChild("Settings")
                if settings then
                    settings:TweenSize(UDim2.new(0, 681, 0, 375), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.3, true)
                    
                    local settingsHolder = settings:FindFirstChild("SettingsHolder")
                    if settingsHolder then
                        task.wait(0.05)
                        settingsHolder:TweenSize(UDim2.new(0, 681, 0, 375), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.25, true)
                    end
                end
            end
            
            -- Change icon back
            MaximizeIcon.Image = "http://www.roblox.com/asset/?id=6035047377"
        end
        isMaximized = not isMaximized
    end)
    
    MaximizeBtn.MouseEnter:Connect(function()
        MaximizeBtn.BackgroundColor3 = Color3.fromRGB(40, 43, 46)
    end)
    ...
    function ServerHold:Server(text, img)
        ...
        function ChannelHold:Channel(text)
            ...
            function ChannelContent:Dropdown(flag, config)
                ...
                for i,v in pairs(config.List) do  -- ✅ PERBAIKAN: config.List bukan config.Values
                ...
                function DropFunc:SetValue(val)
                    if config.Multi then  -- ✅ PERBAIKAN
